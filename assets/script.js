...
var task9Am = document.getElementById("task8Am")
...
taskForm.addEventListener("submit", function (event) {
    ...
    localStorage.setItem("8 AM Task", task8Am.value);
...
window.onload = function () {
    ...
    var savedValue8Am = localStorage.getItem("8 AM Task");
    ...
    document.getElementById("task8Am").value = savedValue8Am;
